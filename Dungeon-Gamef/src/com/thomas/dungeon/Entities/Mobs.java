...
/*     */{
	...
	/*     */{
		/* 34 */Thread x = new Thread(new MobturnThread());
		/* 35 */x.start();
		/*     */}
		...
		/* 108 */for (int i = 0; i < 80; i++)
			/* 109 */for (int j = 0; j < 50; j++)
				...
				/* 111 */(mob[(i + j * 80)].health <= 0)) {
					...
					/*     */}
					/*     */
					/* 121 */Items.setItemOnRandomOffSet(i, j,
							getDrop(mob[(i + j * 80)].Mobtype));
					/*     */}
		/*     */}
	...
	/*     */{
		/* 153 */if (mob[(locationX + locationY * 80)].Mobtype
				.equals("Trombie")) {
		...
		/* 177 */if (mob[(locationX + locationY * 80)].Mobtype.equals("Fly")) {
			...
			/*     */case 0:
				...
				/*     */}
			/*     */}
		/* 189 */if (mob[(locationX + locationY * 80)].Mobtype
				.equals("Vampire")) {
	...
	/*     */
	/*     */public static void hurt(int locationX, int locationY,
			int amountOfHurt, int hurtByPlayer)
	/*     */{
	...
	/*     */{
		/* 230 */if (mob[(LocationX + LocationY * 80)].Mobtype
				.equals("Trombie")) {
			/* 231 */mobType = 2;
			/*     */}
		...
		/* 236 */if (mob[(LocationX + LocationY * 80)].Mobtype.equals("Fly")) {
			/* 237 */mobType = 4;
			/*     */}
		/* 239 */if (mob[(LocationX + LocationY * 80)].Mobtype
				.equals("Vampire")) {
			/* 240 */mobType = 5;
			/*     */}
		/* 242 */switch (mobType) {
		/*     */case 2:
			...
			/*     */else {
				...
				/*     */{
					...
					/*     */else {
						/* 258 */localDirection = TileChecker
								.directionIfNearPlayer(LocationX, LocationY);
						/*     */}
					/*     */
					/* 261 */if (timesTried > 5) {
						...
						/*     */}
					/*     */
					/* 265 */if (TileChecker.isWalkableDirection(mobType,
							LocationX, LocationY, localDirection))
					/*     */{
		...
		/*     */case 3:
			...
			/*     */else {
				...
				/*     */{
					...
					/*     */else {
						/* 292 */localDirection = TileChecker
								.directionIfNearPlayer(LocationX, LocationY);
						/*     */}
					/*     */
					/* 295 */if (timesTried > 5) {
						...
						/*     */}
					/*     */
					/* 299 */if (TileChecker.isWalkableDirection(mobType,
							LocationX, LocationY, localDirection))
					/*     */{
			...
			/*     */else {
				...
				/*     */{
					...
					/*     */{
						...
						/*     */}
					/* 328 */else
						localDirection = TileChecker.directionIfNearPlayer(
								LocationX, LocationY);
					/*     */
					/* 331 */if (timesTried > 5) {
						...
						/*     */}
					/*     */
					/* 335 */if (TileChecker.isWalkableDirection(mobType,
							LocationX, LocationY, localDirection))
					/*     */{
			...
			/*     */else {
				...
				/*     */{
					...
					/* 369 */if (timesTried > 5) {
						...
						/*     */}
					/*     */
					/* 373 */if (TileChecker.isWalkableDirection(mobType,
							LocationX, LocationY, localDirection))
					/*     */{
	...
	/*     */
	/*     */public static void moveMob(int oldLocationX, int oldLocationY,
			int direction)
	/*     */{
		/* 392 */switch (direction) {
		/*     */case 0:
			/* 394 */mob[(oldLocationX + oldLocationY * 80)].direction = 0;
			/* 395 */moveMobToAnyPosition(oldLocationX, oldLocationY,
					oldLocationX, oldLocationY - 1);
			/* 396 */break;
		/*     */case 1:
			/* 398 */mob[(oldLocationX + oldLocationY * 80)].direction = 1;
			/* 399 */moveMobToAnyPosition(oldLocationX, oldLocationY,
					oldLocationX + 1, oldLocationY);
			/* 400 */break;
		/*     */case 2:
			/* 402 */mob[(oldLocationX + oldLocationY * 80)].direction = 2;
			/* 403 */moveMobToAnyPosition(oldLocationX, oldLocationY,
					oldLocationX, oldLocationY + 1);
			/* 404 */break;
		/*     */case 3:
			/* 406 */mob[(oldLocationX + oldLocationY * 80)].direction = 3;
			/* 407 */moveMobToAnyPosition(oldLocationX, oldLocationY,
					oldLocationX - 1, oldLocationY);
			/*     */}
		/*     */}

	/*     */
	/*     */public static void moveMobToAnyPosition(int oldLocationX,
			int oldLocationY, int newLocationX, int newLocationY)
	/*     */{
	...
	/*     */{
		...
		/* 482 */int mobtyppe = Converter
				.convertMobTypeStringToInt(mob[(oldlocationX + oldlocationY * 80)].Mobtype);
		/*     */do
		/*     */{
			...
			/* 487 */if (TileChecker.isWalkable(mobtyppe, locationX, locationY)) {
				/* 488 */moveMobToAnyPosition(oldlocationX, oldlocationY,
						locationX, locationY);
				/* 489 */movedd = true;
				/*     */}
			/*     */else {
 ...
 * com.thomas.dungeon.Entities.Mobs JD-Core Version: 0.6.2
 */