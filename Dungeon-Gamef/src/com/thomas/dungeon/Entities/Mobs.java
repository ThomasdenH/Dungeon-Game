...
/*     */           }
/*     */ 
/* 274 */           if (moved) break;  } while (timesTried < 20);
/*     */       }
/* 276 */       break;
/*     */     case 3:
...
/*     */           }
/*     */ 
/* 308 */           if (moved) break;  } while (timesTried < 20);
/*     */       }
/* 310 */       break;
/*     */     case 4:
...
/*     */           }
/* 328 */           else localDirection = TileChecker.directionIfNearPlayer(LocationX, LocationY);
/*     */ 
/* 331 */           if (timesTried > 5) {
...
/*     */           }
/*     */ 
/* 344 */           if (moved) break;  } while (timesTried < 20);
/*     */       }
/* 346 */       break;
/*     */     case 5:
...
/*     */           }
/* 366 */           else localDirection = TileChecker.directionIfNearPlayer(LocationX, LocationY);
/*     */ 
/* 369 */           if (timesTried > 5) {
 ...
 * Qualified Name:     com.thomas.dungeon.Entities.Mobs
