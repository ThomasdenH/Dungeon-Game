...
/*     */{
	...
	/*     */{
		...
		/* 70 */(getPlayer().loc.getX() == LevelArrayList.allLevels.get(Gamehandler.levelLevel - 1).stairX)
				&& (getPlayer().loc.getY() == LevelArrayList.allLevels.get(Gamehandler.levelLevel - 1).stairY))
			/* 71 */goDownLevel();
		/*     */}
 ...
 * com.thomas.dungeon.Entities.Player JD-Core Version: 0.6.2
 */