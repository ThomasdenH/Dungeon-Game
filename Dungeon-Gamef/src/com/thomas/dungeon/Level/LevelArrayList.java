...
/* 224 */               if ((com.thomas.dungeon.GameTechnical.Game.finalTorches[(xTile - 1 + gf)][(yTile - 1 + gx)] == "rightofwall") || (com.thomas.dungeon.GameTechnical.Game.finalTorches[(xTile - 1 + gf)][(yTile - 1 + gx)] == "leftofwall") || (com.thomas.dungeon.GameTechnical.Game.finalTorches[(xTile - 1 + gf)][(yTile - 1 + gx)] == "underwall") || 
...
/* 261 */               if ((i - 2 + gf < 80) && (j - 2 + gx < 50) && (i - 2 + gf > 0) && (j - 2 + gx > 0) && (
/* 262 */                 (torches[(i - 2 + gf)][(j - 2 + gx)] == "rightofwall") || (torches[(i - 2 + gf)][(j - 2 + gx)] == "leftofwall") || (torches[(i - 2 + gf)][(j - 2 + gx)] == "underwall") || (torches[(i - 2 + gf)][(j - 2 + gx)] == "abovewall"))) {
/* 263 */                 notATorch = false;
/*     */               }
/*     */ 
/*     */             }
 ...
 * Qualified Name:     com.thomas.dungeon.Level.LevelArrayList
