...
/* 386 */                 this.g.drawImage(ScheurVloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/* 387 */               else if (Game.finalVariations[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)].equals("patroon"))
/* 388 */                 this.g.drawImage(PatroonVloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/* 389 */               else if (Game.finalVariations[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)].equals("put"))
/* 390 */                 this.g.drawImage(PutVloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */               else
/* 392 */                 this.g.drawImage(Vloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */             }
...
/*     */               {
/* 397 */                 this.g.drawImage(Vloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */               }
/* 399 */               else this.g.drawImage(Vloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */             }
...
/*     */               {
/* 404 */                 this.g.drawImage(Vloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */               }
/* 406 */               else this.g.drawImage(Vloer, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */ 
/*     */             }
/* 411 */             else if (Game.finalMap[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)].equals("_"))
/*     */             {
/* 413 */               this.g.drawImage(Void, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */             }
/*     */ 
...
/*     */                 {
/* 477 */                   this.g.drawImage(Inventory.itemImage(com.thomas.dungeon.Items.Items.Items[((ScrollX + xTileOpScherm) * 20 + x + ((ScrollY + yTileOpScherm) * 20 + y) * 1620)].itemType), xTileOpScherm * tileSize + x * (
/* 478 */                     tileSize - tileSize / 3) / 20 - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + y * (tileSize - tileSize / 3) / 20 - offsetY * tileSize / Player.timeOneTurn, tileSize / 3, 
/* 479 */                     tileSize / 3, null);
/*     */                 }
/*     */               }
/*     */             }
...
/*     */             {
/* 497 */               this.g.drawImage(Mobs.getMobImage(ScrollX + xTileOpScherm, ScrollY + yTileOpScherm), xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, 
...
/*     */             {
/* 502 */               this.g.drawImage(Chest, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */             }
/*     */           }
...
/*     */     }
/*     */ 
/* 515 */     this.g.drawImage(Player.getPlayer().getPlayerImage(), (this.pla.loc.getX() - ScrollX) * tileSize, (this.pla.loc.getY() - ScrollY) * tileSize, tileSize, tileSize, null);
/* 516 */     if (Player.hitting) {
/* 517 */       switch (Player.directionHitting) {
/*     */       case 0:
/* 519 */         this.g.drawImage(Player.getHitImage(), (this.pla.loc.getX() - ScrollX) * tileSize, (this.pla.loc.getY() - ScrollY - 1) * tileSize, tileSize, tileSize, null);
/* 520 */         break;
/*     */       case 1:
/* 522 */         this.g.drawImage(Player.getHitImage(), (this.pla.loc.getX() - ScrollX + 1) * tileSize, (this.pla.loc.getY() - ScrollY) * tileSize, tileSize, tileSize, null);
/* 523 */         break;
/*     */       case 2:
/* 525 */         this.g.drawImage(Player.getHitImage(), (this.pla.loc.getX() - ScrollX) * tileSize, (this.pla.loc.getY() - ScrollY + 1) * tileSize, tileSize, tileSize, null);
/* 526 */         break;
/*     */       case 3:
/* 528 */         this.g.drawImage(Player.getHitImage(), (this.pla.loc.getX() - ScrollX - 1) * tileSize, (this.pla.loc.getY() - ScrollY) * tileSize, tileSize, tileSize, null);
/*     */       }
/*     */     }
/*     */ 
...
/*     */           {
/* 542 */             this.g.drawImage(Muur, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/* 543 */             if (!TileChecker.equalsUp(ScrollX + xTileOpScherm, ScrollY + yTileOpScherm + 1))
/*     */             {
/* 545 */               this.g.drawImage(Muur, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4, null);
/* 546 */               if (Game.finalVariations[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)].equalsIgnoreCase("Ivy")) {
/* 547 */                 this.g.drawImage(Ivy, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4, null);
/*     */               }
/* 549 */               GradientPaint redtowhite = new GradientPaint(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, Color.black, 
/* 550 */                 xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, tileSize / 4 + yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, new Color(0, 0, 0, 0));
/* 551 */               this.g.setPaint(redtowhite);
/* 552 */               this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4);
/*     */             }
/* 554 */             if (ScrollY + yTileOpScherm >= 80) {
/* 555 */               this.g.drawImage(Muur, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4, null);
/*     */ 
/* 557 */               if (Game.finalVariations[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)].equalsIgnoreCase("Ivy")) {
/* 558 */                 this.g.drawImage(Ivy, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4, null);
/*     */               }
/* 560 */               GradientPaint redtowhite = new GradientPaint(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, Color.black, 
/* 561 */                 xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, tileSize / 4 + yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, new Color(0, 0, 0, 0));
/* 562 */               this.g.setPaint(redtowhite);
/* 563 */               this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4);
/*     */             }
/*     */           }
/* 566 */           if (Game.finalMap[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)] == "x")
/*     */           {
/* 568 */             this.g.drawImage(Steen, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/* 569 */             if (!TileChecker.equalsUp(ScrollX + xTileOpScherm, ScrollY + yTileOpScherm + 1))
/*     */             {
/* 571 */               this.g.drawImage(Steen, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4, null);
/*     */ 
/* 573 */               GradientPaint redtowhite = new GradientPaint(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, Color.black, 
/* 574 */                 xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, tileSize / 4 + yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, new Color(0, 0, 0, 0));
/* 575 */               this.g.setPaint(redtowhite);
/* 576 */               this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4);
/*     */             }
/* 578 */             if (ScrollY + yTileOpScherm >= 80)
/*     */             {
/* 580 */               this.g.drawImage(Steen, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4, null);
/*     */ 
/* 582 */               GradientPaint redtowhite = new GradientPaint(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, Color.black, 
/* 583 */                 xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, tileSize / 4 + yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, new Color(0, 0, 0, 0));
/* 584 */               this.g.setPaint(redtowhite);
/* 585 */               this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize + tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize / 4);
/*     */             }
/*     */           }
/*     */         }
...
/* 603 */                 this.g.drawImage(DeurOverYOpenOnder, xTileOpScherm * tileSize - tileSize / 2 - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 2 - offsetY * tileSize / Player.timeOneTurn, 
/* 604 */                   tileSize * 2, tileSize * 2, null);
/*     */               else {
/* 606 */                 this.g.drawImage(DeurOverYOpenBoven, xTileOpScherm * tileSize - tileSize / 2 - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 2 - offsetY * tileSize / Player.timeOneTurn, 
/* 607 */                   tileSize * 2, tileSize * 2, null);
/*     */               }
/*     */             }
/*     */             else {
/* 611 */               this.g.drawImage(DeurOverY, xTileOpScherm * tileSize - tileSize / 2 - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 2 - offsetY * tileSize / Player.timeOneTurn, tileSize * 2, 
/* 612 */                 tileSize * 2, null);
/*     */             }
/*     */           }
...
/* 618 */                 this.g.drawImage(DeurOverXOpenOnder, xTileOpScherm * tileSize - tileSize / 2 - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 2 + tileSize / 4 + tileSize / 14 - 
/* 619 */                   offsetY * tileSize / Player.timeOneTurn, tileSize * 2, tileSize * 2 * 1 / 4, null);
/*     */               else {
/* 621 */                 this.g.drawImage(DeurOverXOpenBoven, xTileOpScherm * tileSize - tileSize / 2 - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 2 + tileSize / 4 + tileSize / 14 - 
/* 622 */                   offsetY * tileSize / Player.timeOneTurn, tileSize * 2, tileSize * 2 * 1 / 4, null);
/*     */               }
/*     */             }
/*     */             else {
/* 626 */               this.g.drawImage(DeurOverX, xTileOpScherm * tileSize - tileSize / 2 - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 2 + 1 - offsetY * tileSize / Player.timeOneTurn, tileSize * 2, 
/* 627 */                 tileSize * 2, null);
/*     */             }
/*     */           }
/*     */         }
...
/*     */ 
/* 640 */         if ((ScrollX + xTileOpScherm - 1 >= 0) && (ScrollX + xTileOpScherm - 1 < 80) && (ScrollY + yTileOpScherm - 1 >= 0) && (ScrollY + yTileOpScherm - 1 < 50) && (
/* 641 */           (Game.finalTorches[(ScrollX + xTileOpScherm - 1)][(ScrollY + yTileOpScherm - 1)] == "abovewall") || (Game.finalTorches[(ScrollX + xTileOpScherm - 1)][(ScrollY + yTileOpScherm - 1)] == "underwall") || 
/* 642 */           (Game.finalTorches[(ScrollX + xTileOpScherm - 1)][(ScrollY + yTileOpScherm - 1)] == "leftofwall") || (Game.finalTorches[(ScrollX + xTileOpScherm - 1)][(ScrollY + yTileOpScherm - 1)] == "rightofwall"))) {
...
/*     */ 
/* 652 */           this.g.fillRect((xTileOpScherm - 2) * tileSize - offsetX * tileSize / Player.timeOneTurn, (yTileOpScherm - 2) * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize * 3, tileSize * 3);
/*     */         }
/*     */ 
/*     */         try
/*     */         {
...
/* 716 */             this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize);
/*     */           }
/*     */         }
...
/*     */           {
/* 729 */             this.g.drawImage(Torchrow, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */           }
/* 731 */           if (Game.finalTorches[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)] == "leftofwall")
/*     */           {
/* 733 */             this.g.drawImage(Torchlow, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */           }
/* 735 */           if (Game.finalTorches[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)] == "underwall")
/*     */           {
/* 737 */             this.g.drawImage(Torchuw, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */           }
/* 739 */           if (Game.finalTorches[(ScrollX + xTileOpScherm)][(ScrollY + yTileOpScherm)] == "abovewall")
/*     */           {
/* 741 */             this.g.drawImage(Torchaw, xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - tileSize / 4 - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize, null);
/*     */           }
...
/* 745 */             this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize);
/* 746 */           } else if ((com.thomas.dungeon.Fog.Fog.fogpppart[(ScrollX + xTileOpScherm + (ScrollY + yTileOpScherm) * 80)].fog) && (com.thomas.dungeon.Fog.Fog.fogpppart[(ScrollX + xTileOpScherm + (ScrollY + yTileOpScherm) * 80)].wallfog)) {
/* 747 */             this.g.setColor(Color.BLACK);
/* 748 */             this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize);
...
/* 751 */             this.g.fillRect(xTileOpScherm * tileSize - offsetX * tileSize / Player.timeOneTurn, yTileOpScherm * tileSize - offsetY * tileSize / Player.timeOneTurn, tileSize, tileSize);
/*     */           }
/*     */         }
...
/* 882 */               if ((Game.finalTorches[(xTile - 1 + gf)][(yTile - 1 + gx)] == "rightofwall") || (Game.finalTorches[(xTile - 1 + gf)][(yTile - 1 + gx)] == "leftofwall") || (Game.finalTorches[(xTile - 1 + gf)][(yTile - 1 + gx)] == "underwall") || 
...
/* 917 */             if ((i - 2 + gf < 80) && (j - 2 + gx < 50) && (i - 2 + gf > 0) && (j - 2 + gx > 0) && (
/* 918 */               (torches[(i - 2 + gf)][(j - 2 + gx)] == "rightofwall") || (torches[(i - 2 + gf)][(j - 2 + gx)] == "leftofwall") || (torches[(i - 2 + gf)][(j - 2 + gx)] == "underwall") || (torches[(i - 2 + gf)][(j - 2 + gx)] == "abovewall"))) {
/* 919 */               notATorch = false;
/*     */             }
/*     */ 
/*     */           }
 ...
 * Qualified Name:     com.thomas.dungeon.ScreenStuff.Screenprinting
